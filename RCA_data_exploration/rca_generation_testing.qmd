...
This notebook covers testing and development of v5 up to v5.5. The rca_generation_and_validation.qmd includes the final steps for testing and validating results from a tidy version of 5.5, named v6. There we can access the final results.


### Inner polygons error testing
...
#          lat_boundary2 == "U.S. EEZ Boundary South" &
#          lon_boundary1 == "100fm_041503.csv" &
#          lon_boundary2 == "200fm_052803.csv") %>% .[1,]

# instructions_sample <- polygon_instructions_df %>%
#   filter(lat_boundary1 == "40 10.00' N" &
#          lat_boundary2 == "U.S. EEZ Boundary South" &
#          lon_boundary1 == "100fm_031015.csv" &
#          lon_boundary2 == "150fm_020717.csv") %>% .[1,]

# instructions_sample <- polygon_instructions_df %>%
#   filter(lat_boundary1 == "36 00.00' N" &
#          lat_boundary2 == "34 27.00' N" &
#          lon_boundary1 == "Shoreline" &
#          lon_boundary2 == "150fm_100104.csv") %>% .[1,]

# instructions_sample <- polygon_instructions_df %>%
#   filter(lat_boundary1 == "40 10.00' N" &
#          lat_boundary2 == "U.S. EEZ Boundary South" &
#          lon_boundary1 == "100fm_010119.csv" &
#          lon_boundary2 == "150fm_010119.csv") %>% .[1,]
...
#          lon_boundary2 == "200fm_040105.csv") %>% .[1,]

instructions_sample <- polygon_instructions_df %>%
  filter(lat_boundary1 == "34 27.00' N" &
         lat_boundary2 == "U.S. EEZ Boundary South" &
         lon_boundary1 == "75fm_010104.csv" &
         lon_boundary2 == "150fm_030104.csv") %>% .[1,]
...
latitude_lines <- selected_latitude_lines
  ...
  #     rename(geometry = x) %>%
  #     mutate(id = row_number(),.before=geometry) %>% 
  #     st_difference(st_union(coastline_poly))
  ...
  #   ## a basic approach has been used to discard them by adding a surface threshold that excludes them.
  #   ### Exclude polygons with an area greater than 3e9m (easy fix, there must be a better way).
  #   closed_intersections <- st_intersects(closed_rca_lines, sparse = FALSE)
  # 
  #   if (is.null(closed_intersections)){
  #     rca_coastline_polygons_filtered <- no_land_rca
  #   } else {
  ...
  #     selected_polygons <- closed_rca_lines[intersecting_polygons_indices, ]
  # 
