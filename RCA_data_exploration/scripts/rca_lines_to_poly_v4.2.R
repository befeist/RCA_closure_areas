...
##   Version 4.2 fixes the issues associated with crossing issolines and border clip.
##
## ---------------------------

rca_lines_to_polygons_v4.2 <- function(longitude_lines, latitude_lines,eez_poly) {
