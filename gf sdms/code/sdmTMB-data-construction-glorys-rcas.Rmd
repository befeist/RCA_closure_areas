...
# make a raster mask (just zeroes and ones)
template_mask <- st_rasterize(testbin) %>% rast() %>% 
  subst(0,NA)
...
# save mask
writeRaster(template_mask,here('gf sdms','data','rca_raster_mask.tif'))
```
